...
These are the must-haves. Beyond that, we are encouraged to add improvements or features of their own, such as better retrieval, stronger safety checks, clearer reasoning etc.
