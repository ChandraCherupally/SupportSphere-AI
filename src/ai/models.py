...
class AgentResponse(BaseModel):
    ...
    decision_input_tokens: int = Field(
        default=0,
        description="Input tokens consumed by the Decision Gate LLM call."
    )
    decision_output_tokens: int = Field(
        default=0,
        description="Output tokens generated by the Decision Gate LLM call."
    )
    generation_input_tokens: int = Field(
        default=0,
        description="Input tokens consumed by the Generation LLM call."
    )
    generation_output_tokens: int = Field(
        default=0,
        description="Output tokens generated by the Generation LLM call."
    )